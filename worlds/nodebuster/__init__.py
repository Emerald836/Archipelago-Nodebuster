...
from .items import upgrade_items, ItemDict, base_id, NodebusterItem
...
class NodebusterWorld(World):
    ...
    def create_items(self) -> None:
     ...
     #   useful_items = self.all_items.copy()
       ...
       # if self.options.goal != Goal.option_release_virus:
    ...
    def create_regions(self) -> None:
        used_regions = nodebuster_regions_all# if self.options.goal != Goal.option_first_act \
           # else nodebuster_regions_all
