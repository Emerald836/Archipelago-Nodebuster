...
func vanilla_118915776__ready() -> void:
	Refs.drop_creator.picked_up.connect(_on_pickup_drop)

func vanilla_118915776_set_spawn_rates(spawn_rates: Dictionary) -> void:
...
var t: float
func vanilla_118915776__process(delta: float) -> void:
...
func vanilla_118915776_spawn_enemy(enemy_resource_type: int, enemy_type: String) -> Enemy:
...
func vanilla_118915776_spawn_boss() -> void:
...
func vanilla_118915776__create_enemy(enemy_scn: PackedScene, resource_type: int, health: float,
...
func vanilla_118915776_randomly_place_enemy(enemy: Enemy) -> void:
...
func vanilla_118915776_get_random_spawn_pos(offset: float) -> Vector2:
...
func vanilla_118915776_get_random_enemy() -> Enemy:
	return get_child(randi_range(0, get_child_count()-1))

func vanilla_118915776__on_enemy_out_of_bounds(enemy: Enemy) -> void:
	enemy.queue_free()

func vanilla_118915776__on_boss_out_of_bounds(boss: Enemy) -> void:
	randomly_place_enemy(boss)

func vanilla_118915776__on_enemy_died(enemy: Enemy) -> void:
	enemy.set_dead()
...
func vanilla_118915776__create_drops(drop_count: int, resource_type: int, base_pos: Vector2,
...
func vanilla_118915776__create_pentagon_children(resource_type: int, base_pos: Vector2, move_dir: Vector2)\
 -> void:
...
func vanilla_118915776__on_pickup_drop(resource_type: int) -> void:
	var amount: int = 1
...
func _ready():
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_118915776__ready, [], 872389684)
	else:
		vanilla_118915776__ready()


func set_spawn_rates(spawn_rates: Dictionary):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_118915776_set_spawn_rates, [spawn_rates], 78094034)
	else:
		vanilla_118915776_set_spawn_rates(spawn_rates)


func _process(delta: float):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_118915776__process, [delta], 3081934014)
	else:
		vanilla_118915776__process(delta)


func spawn_enemy(enemy_resource_type: int, enemy_type: String) -> Enemy:
	if _ModLoaderHooks.any_mod_hooked:
		return _ModLoaderHooks.call_hooks(vanilla_118915776_spawn_enemy, [enemy_resource_type, enemy_type], 2496586438)
	else:
		return vanilla_118915776_spawn_enemy(enemy_resource_type, enemy_type)


func spawn_boss():
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_118915776_spawn_boss, [], 2418257311)
	else:
		vanilla_118915776_spawn_boss()


func _create_enemy(enemy_scn: PackedScene, resource_type: int, health: float, 
damage: float, move_speed: float, rotate_speed: float, scale_val: float) -> Enemy:
	if _ModLoaderHooks.any_mod_hooked:
		return _ModLoaderHooks.call_hooks(vanilla_118915776__create_enemy, [enemy_scn, resource_type, health, damage, move_speed, rotate_speed, scale_val], 986424080)
	else:
		return vanilla_118915776__create_enemy(enemy_scn, resource_type, health, damage, move_speed, rotate_speed, scale_val)


func randomly_place_enemy(enemy: Enemy):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_118915776_randomly_place_enemy, [enemy], 1425590055)
	else:
		vanilla_118915776_randomly_place_enemy(enemy)


func get_random_spawn_pos(offset: float) -> Vector2:
	if _ModLoaderHooks.any_mod_hooked:
		return _ModLoaderHooks.call_hooks(vanilla_118915776_get_random_spawn_pos, [offset], 4182606873)
	else:
		return vanilla_118915776_get_random_spawn_pos(offset)


func get_random_enemy() -> Enemy:
	if _ModLoaderHooks.any_mod_hooked:
		return _ModLoaderHooks.call_hooks(vanilla_118915776_get_random_enemy, [], 2330782941)
	else:
		return vanilla_118915776_get_random_enemy()


func _on_enemy_out_of_bounds(enemy: Enemy):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_118915776__on_enemy_out_of_bounds, [enemy], 4018108014)
	else:
		vanilla_118915776__on_enemy_out_of_bounds(enemy)


func _on_boss_out_of_bounds(boss: Enemy):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_118915776__on_boss_out_of_bounds, [boss], 3602408103)
	else:
		vanilla_118915776__on_boss_out_of_bounds(boss)


func _on_enemy_died(enemy: Enemy):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_118915776__on_enemy_died, [enemy], 557895822)
	else:
		vanilla_118915776__on_enemy_died(enemy)


func _create_drops(drop_count: int, resource_type: int, base_pos: Vector2, 
scatter_radius: float):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_118915776__create_drops, [drop_count, resource_type, base_pos, scatter_radius], 985392890)
	else:
		vanilla_118915776__create_drops(drop_count, resource_type, base_pos, scatter_radius)


func _create_pentagon_children(resource_type: int, base_pos: Vector2, move_dir: Vector2):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_118915776__create_pentagon_children, [resource_type, base_pos, move_dir], 618587702)
	else:
		vanilla_118915776__create_pentagon_children(resource_type, base_pos, move_dir)


func _on_pickup_drop(resource_type: int):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_118915776__on_pickup_drop, [resource_type], 570886939)
	else:
		vanilla_118915776__on_pickup_drop(resource_type)
