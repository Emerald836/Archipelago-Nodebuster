...
func vanilla_376148877__ready() -> void:
...
func vanilla_376148877__process(delta: float) -> void:
...
func vanilla_376148877_pulse() -> void:
...
func _ready():
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_376148877__ready, [], 4148384449)
	else:
		vanilla_376148877__ready()


func _process(delta: float):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_376148877__process, [delta], 1522410123)
	else:
		vanilla_376148877__process(delta)


func pulse():
	if _ModLoaderHooks.any_mod_hooked:
		await _ModLoaderHooks.call_hooks_async(vanilla_376148877_pulse, [], 145985302)
	else:
		await vanilla_376148877_pulse()
