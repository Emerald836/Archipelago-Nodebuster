...
func vanilla_4051784109_get_max_health() -> int:
...
func get_max_health() -> int:
	if _ModLoaderHooks.any_mod_hooked:
		return _ModLoaderHooks.call_hooks(vanilla_4051784109_get_max_health, [], 3902138503)
	else:
		return vanilla_4051784109_get_max_health()
